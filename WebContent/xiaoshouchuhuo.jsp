...
<div class="main-content-inner">
		<form id="searchForm" class="form-inline" role="form"
			...
			<div class="form-group">
				<label class="form-label">客户:</label> <select
					class="kehu-list2" name="kehuID"
					data-placeholder="选择客户" style="width: 170px;"></select>
			</div>
			<div class="form-group">
		...
		<form id="saveuserForm">
			<table
				...
				<tr>
					...
					<td><select class="kehu-list" name="kehuID"
						data-placeholder="选择客户" style="width: 170px;"></select></td>
				</tr>
				<tr>
		...
		$(function() {
			...
			function loadUserList() {
				...
				var searchParam = {
					...
					kehuID : searchForm.find(
							"select[name='kehuID']").val(),
				...
				$.ajax({
					...
					success : function(result) {
						if(type==1) {
							...
							for (var i = 0; i < result.kehuList.length; i++) {
								list.push(result.kehuList[i]);
							}
							var rendered = Mustache.render(kehuTemplate, {
								"kehuList" : list
							});
							$('.kehu-list2').html(rendered);
						} else {
							var rendered = Mustache.render(kehuTemplate, {
								"kehuList" : result.kehuList
							});
